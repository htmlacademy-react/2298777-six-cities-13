...
const OfferImageWrapper : FC<OfferImageWrapperProps> = ({offer, isFavoriteCard = false}) => (
  <div className={cn({'cities__image-wrapper': !isFavoriteCard}, {'favorites__image-wrapper': isFavoriteCard}, 'place-card__image-wrapper')} data-testid='offer-image-wrapper'>
